...
<div class="container">
    ...
    <ul>
        ...
        <li><a href="{SITEURL}/examples/cms/hello_world_second/message/Hi All">Call a method message with a
                parameter</a></li>
        <li><a href="{SITEURL}/examples/cms/hello_world_second/mobile/Hello Mobile GUI">Call a method message inside
                mobile design</a></li>
        ...
        <li><a href="{SITEURL}/examples/cms/hello_world_second/message/Param1/Param2">Exception: Parameters errors</a>
        </li>
