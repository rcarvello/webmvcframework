...
<div class="container py-4">
    <h1 class="mb-2">AI / PartsManager</h1>
    <p class="text-body-secondary">Elenco della tabella <strong>part</strong> in forma di DataTable AJAX.</p>

    <div class="table-responsive">
        <table class="table table-striped table-bordered table-hover align-middle w-100" id="table_parts">
            <thead>
            <tr>
                <th>Part code</th>
                <th>Description</th>
    ...
    <div class="d-flex flex-wrap gap-2 mt-3 align-items-center">
        <div id="parts_manager_export_buttons" class="d-flex flex-wrap gap-2"></div>
        <a href="{GLOBAL:SITEURL}/ai/parts_manager" class="btn btn-primary"><i class="bi bi-arrow-clockwise me-1"></i>Reload
            PartsManager</a>
    </div>
</div>
...
<script>
    $(document).ready(function () {
        ...
        var tableStateKey = 'datatable:ai:parts_manager';
        ...
        var table = $('#table_parts').DataTable({
            ...
            "columns": [
                ...
                {"data": "description"},
                {"data": "source"},
                {"data": "source_lead_time"},
                {"data": "measurement_unit_code"},
                {"data": "part_type_code"},
                {"data": "part_category_code"},
                {"data": "wastage"},
                {"data": "bom_levels"}
            ],
            "language": {
                ...
                "search": "Cerca",
                "searchPlaceholder": "Filtra parti",
        ...
        table.buttons().container().appendTo('#parts_manager_export_buttons');

        var filter = $('#table_parts_filter');
        var searchInput = filter.find('input');

        searchInput.attr({
            'type': 'search',
            'placeholder': 'Filtra parti'
        });
