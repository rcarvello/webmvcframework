    ...
    <form class="form" method="post" name="c_form" enctype="multipart/form-data">
        <div class="form-group">
            <div class="input-group">
                ...
                <span class="input-group-btn">
                        <a class="btn btn-default" id="addSubSystemButton" data-toggle="modal"
                           data-target="#addSubSystemModalForm">
        ...
        <div class="form-group">
            <input type="text" class="form-control" id="controller" name="controller"
                   placeholder="Type the MVC entity name to create" required>
        </div>

        <div class="form-group">
            <input type="file" name="template" class="filestyle" data-buttonText=""
                   data-placeholder="Select your custom HTML Template (optional)">
        </div>
        ...
        <button type="submit" class="btn btn-success"><span class="glyphicon glyphicon-ok"></span> Create Skeleton
        </button>
        <a href="template_editor" class="btn btn-warning"><span class="glyphicon glyphicon-pencil"></span> Edit Template
            Design <span class="badge">{DesignStatus}</span></a>
            ...
            <form role="form" action="skeleton_builder" method="post">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="childSubSystem" name="childSubSystem"
                               placeholder="Type the name of child subsystem to create" required/>
                    </div>

                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                    <button type="submit" class="btn btn-success"><span class="glyphicon glyphicon-ok"></span> Create
                        subsystem
                    </button>
                </div>
            </form>
